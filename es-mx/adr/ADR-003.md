...
### 2.1 Synapse (Abstracción de Transporte)

El **Synapse** es la capa de abstracción de transporte que implementa los requisitos de conexión mTLS definidos anteriormente.

Un Synapse:

* Representa una conexión a un módulo fuera de proceso
* Adjunta pruebas de lease y metadatos de ejecución a todas las invocaciones
* Maneja serialización y preocupaciones de nivel de transporte
* Proporciona una superficie de invocación opaca para capas superiores
* Aplica requisitos de metadatos automáticamente
* Abstrae el mecanismo de transporte de la lógica de negocio
* Hace límites de proceso explícitos

Los Synapses no contienen **semántica de negocio o lógica de autorización** — delegan a la autoridad de lease y existen puramente para aplicar separación de límite de proceso y garantizar vinculación de lease para todas las invocaciones.
...
* Lista negra
* Reimplementación obligatoria o aislamiento (sandboxing)
