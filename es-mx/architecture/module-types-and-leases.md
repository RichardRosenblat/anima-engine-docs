# Tipos de Módulos y Autorización Basada en Lease

**ADR Relacionado:** [ADR-003: Protocolo de Comunicación Core ↔ Módulo, Tipos de Módulos y Ciclo de Vida de Lease](../adr/ADR-003.md)
...
### Mecanismo Único de Comunicación
...
### Seguridad de Transporte e Identidad
...
## Modelo de Autorización Basado en Lease
...
### Autoridad de Lease (Invariante Crítica)
...
### Handshake y Establecimiento de Lease
...
### Promoción y Degradación de Alcance de Lease
