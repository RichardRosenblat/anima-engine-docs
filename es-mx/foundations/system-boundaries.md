...
* [Carta del Proyecto](project-charter.md) - Valores centrales y no-objetivos
* [Modelo de Seguridad](safety-model.md) - Arquitectura de seguridad y protección
* [Modelo de Amenazas](threat-model.md) - Análisis y mitigación de amenazas
...
Este documento define **qué puede y no puede hacer ANIMA** por diseño.

Estos límites son **impuestos por la arquitectura**, no por convención. Las violaciones se tratan como bugs de seguridad, no solicitudes de funcionalidades.

---

## Lo que el Motor NUNCA Puede Hacer

Estas restricciones son **invariantes arquitectónicas** y no pueden ser eludidas.
...
**Related:** [Seed System](architecture/seed-system.md), [Carta del Proyecto](project-charter.md)
...
**Related:** [Modelo de Seguridad](safety-model.md), [Module Types and Leases](architecture/module-types-and-leases.md)
...
* Nivel de Riesgo del Usuario y Nivel de Riesgo del Sistema declarados en el contrato de capacidad (ver [Glosario Canónico](canonical-glossary.md))
* Confirmación multi-canal (ej: voz + GUI)
* Reafirmación explícita de intención requerida
