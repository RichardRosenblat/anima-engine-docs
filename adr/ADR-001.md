...
A **Seed** is a declarative configuration used to initialize a ANIMA identity.
...
Once initialized, a ANIMA instance evolves independently using instance-local memory only.
