...
* [Project Charter](project-charter.md) - Core values and non-goals
...
This document defines **what ANIMA can and cannot do** by design.

These boundaries are **enforced by architecture**, not convention. Violations are treated as security bugs, not feature requests.

---

## What the Engine Can NEVER Do

These constraints are **architectural invariants** and cannot be bypassed.
...
**Related:** [Seed System](architecture/seed-system.md), [Project Charter](project-charter.md)
...
**Related:** [Safety Model](safety-model.md), [Module Types and Leases](architecture/module-types-and-leases.md)
